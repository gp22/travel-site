...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    // Select all elements that have class="lazyload".
    // We need to do this so that waypoints can update page
    // coordinates each time lazyload downloads a new image.
  ...
  // Update waypoints each time lazyload loads a new image.
